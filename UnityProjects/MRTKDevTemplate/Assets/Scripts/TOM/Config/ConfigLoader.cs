...
namespace TOM.Common.Config
{
    ...
    public class ConfigLoader : MonoBehaviour
    {
        ...
        private string getConfigDirectory()
        {
            ...
            // return Application.persistentDataPath + Path.DirectorySeparatorChar + FILE_DIRECTORY;
